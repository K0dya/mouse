...
class DIP(tk.Frame):
    ...
    def initUI(self):
        ...
        basicMenu.add_command(label="Threshold", command=self.onThreshold)
        basicMenu.add_command(label="ThresholdBin", command=self.onThreshBin)
        basicMenu.add_command(label="GaussianBlur", command=self.onGauss)
        basicMenu.add_command(label="medianBlur", command=self.onMedian)
    ...
    def onScale(self):
        ...
        self.slSc = tk.Scale(self.tool_frame, label="scale", from_=5, to=200, orient=tk.HORIZONTAL, command=self.Scale, length=100,
    ...
    def onHough(self):
        self.configure_frame()
        self.HoSc1 = tk.Scale(self.tool_frame, label="minDist", from_=1, to=100, orient=tk.HORIZONTAL, command=self.adjDis,
        ...
        self.HoSc3 = tk.Scale(self.tool_frame, label="minRadius", from_=1, to=20, orient=tk.HORIZONTAL, command=self.adjRad1,
                              length=200, width=10, sliderlength=15)
        self.HoSc3.pack(anchor=tk.W)
        self.HoSc4 = tk.Scale(self.tool_frame, label="maxRadius", from_=0, to=100, orient=tk.HORIZONTAL, command=self.adjRad2,
                              length=200, width=10, sliderlength=15)
        self.HoSc4.pack(anchor=tk.W)
        self.HoSc5 = tk.Scale(self.tool_frame, label="higher_thresh", from_=1, to=100, orient=tk.HORIZONTAL, command=self.adjPar1,
                              length=200, width=10, sliderlength=15)
        self.HoSc5.pack(anchor=tk.W)
        self.HoSc6 = tk.Scale(self.tool_frame, label="acc_thresh", from_=1, to=255, orient=tk.HORIZONTAL, command=self.adjPar2,
                              length=200, width=10, sliderlength=15)
    ...
    def adjRad1(self, minRad):
        self.minRadius = int(minRad)
        print(self.minRadius)
        self.Houghh()

    def adjRad2(self, maxRad):
        self.maxRadius = int(maxRad)
    ...
    def onThreshBin(self):
        ...
        self.configure_frame()
        self.BinSc1 = tk.Scale(self.tool_frame,label="thresh", from_=0, to=255, orient=tk.HORIZONTAL, command=adj_thresh, length=200,
                           width=10, sliderlength=15)
        self.BinSc1.pack(anchor=tk.W)
        self.BinSc2 = tk.Scale(self.tool_frame,label="max_val", from_=0, to=255, orient=tk.HORIZONTAL, command=adj_max_val, length=200,
                           width=10, sliderlength=15)
    ...
    def onClahe(self):
        ...
        self.clSc1 = tk.Scale(self.tool_frame, from_=1, to=10, orient=tk.HORIZONTAL, command=self.adjLimit, length=200, width=10,
                              sliderlength=15)
...
#--------------------TRESHOLD-------------------------------------
    ...
    def onCnt(self):
        self.configure_frame()
        self.cntSc1 = tk.Scale(self.tool_frame,label="len", from_=5, to=10, orient=tk.HORIZONTAL, command=self.adjlen, length=200, width=10,
                               sliderlength=15)
        self.cntSc1.pack(anchor=tk.W)
        self.cntSc2 = tk.Scale(self.tool_frame, label="area min",from_=5, to=1000, orient=tk.HORIZONTAL, command=self.adjArea1, length=200, width=10,
                               sliderlength=15)
        self.cntSc2.pack(anchor=tk.W)
        self.cntSc3 = tk.Scale(self.tool_frame, label="area max", from_=100, to=80000, orient=tk.HORIZONTAL, command=self.adjArea2, length=200, width=10,
                               sliderlength=15)
        self.cntSc3.pack(anchor=tk.W)
        self.cntSc4 = tk.Scale(self.tool_frame, label="diam", from_=10, to=1000, orient=tk.HORIZONTAL, command=self.adjDiam, length=200, width=10,
                               sliderlength=15)
